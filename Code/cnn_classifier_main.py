...
from Code.cnn_classification import predict_class
...
trained_cnn_classifier = load_model(
    filepath='/Users/Michael/PycharmProjects/School/computer-vision-project/Models/cnnclassifier.h5')
visualize_training_history(
    filepath='/Users/Michael/PycharmProjects/School/computer-vision-project/Models/Training History/history_cnn.pckl',
    activation='Softmax', loss='binary crossentropy')
...
# only for retraining
# cnn_class = create_random_classifier(im_shape=(64, 64, 3))
# trained_cnn_class = train_cnn(cnn=cnn_class, filename='cnn_random', x_train=x_train, y_train=y_train, epochs=50,
#                            validation_data=(x_val, y_val))
# save_model(model=trained_cnn_class,
